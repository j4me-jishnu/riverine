...
(function($) {
    ...
    $.formUtils = {
        ...
        */
        LANG : {
            ...
            locationCode : 'Enter two characters',
            badAddress : 'You have not given a correct  address',
            badEmail : 'You have not given a correct e-mail address',
            badTelephone : 'You have not given a correct phone number',
            badSecurityAnswer : 'You have not given a correct answer to the security question',
            badDate : 'You have not given a correct date',
            badUsPhone : 'Please enter a valid US phone number.',
            badFax : 'Please enter a valid US fax number.',
            ...
            badPass : 'The password isn\'t strong enough',
            ...
            badcity : 'The CVV number was not correct',
            badZip : 'Please enter valid Zipcode'
        }
    };
    ...
    */
    $.formUtils.addValidator({
        ...
        validatorFunction : function(val, $el, conf) {
            console.log($el.valAttr('allowing'),'el');
            if(val !== '') {
    ...
    */
	...
	name : 'date',
	    ...
	    console.log($el);
	    var pms_required = $el.attr("data-pms-required");
	    console.log(pms_required);
	    if(pms_required == 'false'){
		return true;
	    }
