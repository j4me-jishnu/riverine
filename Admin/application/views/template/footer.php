  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      <b>Call us on +91 95670 36355 ,+91 9747776355</b>
    </div>-->
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="#">Wahylab Solutions</a>.</strong> All rights reserved.
  </footer>
...
<!-- Combogrid autosuggest -->
<script src="<?php echo base_url();?>assets/dist/js/jquery-ui-autocomplete.min.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/plugins/combogrid/combogrid.js"></script>
<!-- date-range-picker -->
...
<script src="<?php echo base_url();?>assets/dist/js/pms-common.js"></script>
<!-- ChartJS -->
<script src="<?php echo base_url();?>assets/Chart.js/Chart.js"></script>
<!-- Form validations start here-->
<script src="<?php echo base_url();?>assets/plugins/formvalidator/jquery.form-validator.js"></script>
<script src="<?php echo base_url();?>assets/plugins/formvalidator/validator_default.js"></script>
...
<script src="<?php echo base_url();?>assets/dist/js/jquery.noty.js"></script>
<!-- SlimScroll 1.3.0 -->
