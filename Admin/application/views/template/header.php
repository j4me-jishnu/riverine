...
<head>
  ...
  <title>Riverine Suits - Admin</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a class="logo" style="background-color: #aa8453;">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>RS</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">RIVERINE SUITS</span>
    </a>
    <!-- Header Navbar -->
    <nav class="navbar navbar-static-top" style="background-color: #aa8453;" role="navigation">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <!-- <li class="user-header">
                <img src="<?php echo base_url();?>uploads/logo_aiswarya_ads.png" class="img-circle" alt="User Image"> -->
                <!--<p>
